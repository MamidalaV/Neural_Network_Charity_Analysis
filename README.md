...
HDF5 files for all the above models are saved in the ![Resources](https://github.com/MamidalaV/Neural_Network_Charity_Analysis/tree/main/Challenge/Resources) folder.
